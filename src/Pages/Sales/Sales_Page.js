...
export default function Sales_Page(props) {
...
function Sale_Form(props) {
    ...
    const Post_Sale=async (address,values)=>{
    ...
    if (validate()) {
      ...
      Swal.fire({
        ...
        if (result.isConfirmed) {
          ...
          Post_Sale('Sales/',values);;
          resetForm();
          get_bill_number('get_sale_bill_number')
